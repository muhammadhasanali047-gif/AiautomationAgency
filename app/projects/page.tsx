          ...
          {projects.map((project) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-[16/9] w-full bg-gradient-to-br from-slate-100 to-slate-50 border-b border-slate-200/80 overflow-hidden flex items-center justify-center p-6">
